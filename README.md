...
## 아두이노 - 심재현
### 기능 
  1. 라즈베리파이에서 전달된 신호 받기 
  2. 스피커와 진동장치를 내장하여 아두이노의 출력값을 통해 운전자에게 청각적/촉각적 경고 신호를 전달
 
## 앱개발 - 이승돈
###기능 
  1. 라즈베리파이에서 전달받은 영상파일을 서버로 보내기
  2. 운전자의 졸음 패턴과 부주의를 데이터로 저장하고 분석하여, 운전습관과 점수제를 적용
